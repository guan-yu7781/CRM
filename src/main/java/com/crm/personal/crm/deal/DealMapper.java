...
public interface DealMapper {
    ...
    @Select("select d.id, d.title, d.amount, d.currency, d.stage, d.opportunity_type, d.market, d.expected_close_date, d.notes, d.customer_id, " +
    ...
    @Insert("insert into deals " +
            "(title, amount, currency, stage, opportunity_type, market, expected_close_date, notes, customer_id, converted_project_id, converted_at, created_at, updated_at) " +
            "values " +
            "(#{title}, #{amount}, #{currency}, #{stage}, #{opportunityType}, #{market}, #{expectedCloseDate}, #{notes}, #{customerId}, #{convertedProjectId}, #{convertedAt}, #{createdAt}, #{updatedAt})")
